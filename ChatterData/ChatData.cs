...
namespace ChatterData
{
    ...
    {
        //private static string m_ConnectionString = "Server=.;Database=Chatter;User ID=ChatterLogin;pwd=chat";
        private static string m_ConnectionString = "Data Source=MARK;Initial Catalog=Chatter;Integrated Security=True";
